...
def get_sentiment(text):
    ...
    if sample_prediction.flatten()[0] > 0.5:
        return f'Positive sentiment! 😃 Model output was {round(sample_prediction.flatten()[0], 3)}.'
    else:
        return f'Negative Sentiment. 😔 Model output was {round(sample_prediction.flatten()[0], 3)}.'
